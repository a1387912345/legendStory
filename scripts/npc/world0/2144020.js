...
function Tutorial3() {
    if (chat == 0)
        ...
        cm.sendNextPrev("Have I already proved you that you must resurrect me?", 3);
    else if (chat == 2)
        cm.sendNextPrev("There's one more thing, In order to get out of here you must touch the darkness.");
    else if (chat == 3)
        cm.sendNextPrev("HUH?! Touch the darkness? And how will I do that?");
    else if (chat == 4) {
